...
export class Bag {
  ...
  ngOnInit() {
    ...
    const home_page$ = this.store.dispatch(
      new GetHomePageAction({ slug: "bag" }),
    );
      ...
      this.form.patchValue({
        content: {
          ...
          product_banner: {
            ...
            left_content: {
              product_ids:
                homePage?.content?.product_banner?.left_content?.product_ids,
            ...
            center_content: {
              ...
              product_ids:
                homePage?.content?.product_banner?.center_content?.product_ids,
              status: homePage?.content?.product_banner?.center_content?.status,
            },
            right_content: {
              product_ids:
                homePage?.content?.product_banner?.right_content?.product_ids,
