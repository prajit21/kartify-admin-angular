...
export class VideoSlider {
  ...
  home_page$: Observable<IVideoSlider> = inject(Store).select(
    ThemeState.homePage,
  );
  ...
  ngOnInit() {
    ...
    const home_page$ = this.store.dispatch(
      new GetHomePageAction({ slug: "video_slider" }),
    );
      ...
      this.form.patchValue({
        content: {
          ...
          collection_banner: {
            banner_1: {
              image_url:
                homePage?.content?.collection_banner?.banner_1?.image_url,
              ...
              redirect_link: {
                link: homePage?.content?.collection_banner?.banner_1
                  ?.redirect_link?.link,
                link_type:
                  homePage?.content?.collection_banner?.banner_1?.redirect_link
                    ?.link_type,
                product_ids:
                  homePage?.content?.collection_banner?.banner_1?.redirect_link
                    ?.product_ids,
            ...
            banner_2: {
              image_url:
                homePage?.content?.collection_banner?.banner_2?.image_url,
              ...
              redirect_link: {
                link: homePage?.content?.collection_banner?.banner_2
                  ?.redirect_link?.link,
                link_type:
                  homePage?.content?.collection_banner?.banner_2?.redirect_link
                    ?.link_type,
                product_ids:
                  homePage?.content?.collection_banner?.banner_2?.redirect_link
                    ?.product_ids,
            ...
            banner_3: {
              image_url:
                homePage?.content?.collection_banner?.banner_3?.image_url,
              ...
              redirect_link: {
                link: homePage?.content?.collection_banner?.banner_3
                  ?.redirect_link?.link,
                link_type:
                  homePage?.content?.collection_banner?.banner_3?.redirect_link
                    ?.link_type,
                product_ids:
                  homePage?.content?.collection_banner?.banner_3?.redirect_link
                    ?.product_ids,
