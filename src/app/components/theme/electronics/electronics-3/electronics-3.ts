...
export class Electronics3 {
  ...
  home_page$: Observable<IElectronicThree> = inject(Store).select(
    ThemeState.homePage,
  );
  ...
  ngOnInit() {
    ...
    const home_page$ = this.store.dispatch(
      new GetHomePageAction({ slug: "electronics_three" }),
    );
  ...
  patchForm() {
    this.home_page$.subscribe((homePage) => {
      ...
      this.selectedProductCategory =
        homePage?.content?.category_product_2?.category_ids || [];
        ...
        content: {
          ...
          banner: {
            main_banner: {
              ...
              redirect_link: {
                link: homePage?.content?.banner?.main_banner?.redirect_link
                  ?.link,
                link_type:
                  homePage?.content?.banner?.main_banner?.redirect_link
                    ?.link_type,
                product_ids:
                  homePage?.content?.banner?.main_banner?.redirect_link
                    ?.product_ids,
            ...
            grid_banner_1: {
              ...
              redirect_link: {
                link: homePage?.content?.banner?.grid_banner_1?.redirect_link
                  ?.link,
                link_type:
                  homePage?.content?.banner?.grid_banner_1?.redirect_link
                    ?.link_type,
                product_ids:
                  homePage?.content?.banner?.grid_banner_1?.redirect_link
                    ?.product_ids,
            ...
            grid_banner_2: {
              ...
              redirect_link: {
                link: homePage?.content?.banner?.grid_banner_2?.redirect_link
                  ?.link,
                link_type:
                  homePage?.content?.banner?.grid_banner_2?.redirect_link
                    ?.link_type,
                product_ids:
                  homePage?.content?.banner?.grid_banner_2?.redirect_link
                    ?.product_ids,
            ...
            grid_banner_3: {
              ...
              redirect_link: {
                link: homePage?.content?.banner?.grid_banner_3?.redirect_link
                  ?.link,
                link_type:
                  homePage?.content?.banner?.grid_banner_3?.redirect_link
                    ?.link_type,
                product_ids:
                  homePage?.content?.banner?.grid_banner_3?.redirect_link
                    ?.product_ids,
          ...
          category_product_1: {
            ...
            products: {
              product_ids:
                homePage?.content?.category_product_1?.products?.product_ids,
          ...
          offer_banner_1: {
            ...
            redirect_link: {
              ...
              link_type:
                homePage?.content?.offer_banner_1?.redirect_link?.link_type,
              product_ids:
                homePage?.content?.offer_banner_1?.redirect_link?.product_ids,
            },
          },
          offer_banner_2: {
            banner_1: {
