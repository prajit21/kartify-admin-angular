...
export class Electronics2 {
  ...
  home_page$: Observable<IElectronicTwo> = inject(Store).select(
    ThemeState.homePage,
  );
  ...
  ngOnInit() {
    ...
    const home_page$ = this.store.dispatch(
      new GetHomePageAction({ slug: "electronics_two" }),
    );
        ...
        content: {
          home_banner: {
            banner_1: {
              ...
              redirect_link: {
                link: homePage?.content?.home_banner?.banner_1?.redirect_link
                  ?.link,
                link_type:
                  homePage?.content?.home_banner?.banner_1?.redirect_link
                    ?.link_type,
                product_ids:
                  homePage?.content?.home_banner?.banner_1?.redirect_link
                    ?.product_ids,
            ...
            banner_2: {
              ...
              redirect_link: {
                link: homePage?.content?.home_banner?.banner_2?.redirect_link
                  ?.link,
                link_type:
                  homePage?.content?.home_banner?.banner_2?.redirect_link
                    ?.link_type,
                product_ids:
                  homePage?.content?.home_banner?.banner_2?.redirect_link
                    ?.product_ids,
            ...
            banner_3: {
              ...
              redirect_link: {
                link: homePage?.content?.home_banner?.banner_3?.redirect_link
                  ?.link,
                link_type:
                  homePage?.content?.home_banner?.banner_3?.redirect_link
                    ?.link_type,
                product_ids:
                  homePage?.content?.home_banner?.banner_3?.redirect_link
                    ?.product_ids,
