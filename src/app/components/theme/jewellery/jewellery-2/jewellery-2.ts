...
export class Jewellery2 {
  ...
  home_page$: Observable<IJewelryTwo> = inject(Store).select(
    ThemeState.homePage,
  );
  ...
  ngOnInit() {
    const home_page$ = this.store.dispatch(
      new GetHomePageAction({ slug: "jewellery_two" }),
    );
        ...
        content: {
          ...
          banner: {
            ...
            redirect_link: {
              ...
              product_ids:
                homePage?.content?.banner?.redirect_link?.product_ids,
            },
          },
          services: {
          ...
          product_banner: {
            ...
            center_panel: {
              banner_1: {
                image_url:
                  homePage?.content?.product_banner?.center_panel.banner_1
                    ?.image_url,
                status:
                  homePage?.content?.product_banner?.center_panel.banner_1
                    ?.status,
                redirect_link: {
                  link: homePage?.content?.product_banner?.center_panel.banner_1
                    ?.redirect_link?.link,
                  link_type:
                    homePage?.content?.product_banner?.center_panel.banner_1
              ...
              banner_2: {
                image_url:
                  homePage?.content?.product_banner?.center_panel.banner_2
                    ?.image_url,
                status:
                  homePage?.content?.product_banner?.center_panel.banner_2
                    ?.status,
                redirect_link: {
                  link: homePage?.content?.product_banner?.center_panel.banner_2
                    ?.redirect_link?.link,
                  link_type:
                    homePage?.content?.product_banner?.center_panel.banner_2
                      ?.redirect_link?.link_type,
