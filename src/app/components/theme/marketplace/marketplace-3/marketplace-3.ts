...
export class Marketplace3 {
  ...
  home_page$: Observable<IMarketplaceThree> = inject(Store).select(
    ThemeState.homePage,
  );
  ...
  ngOnInit() {
    ...
    const home_page$ = this.store.dispatch(
      new GetHomePageAction({ slug: "marketplace_three" }),
    );
  ...
  patchForm() {
    this.home_page$.subscribe((homePage) => {
      ...
      this.selectedCategories =
        homePage?.content?.categories_products.left_panel.categories
          .category_ids || [];
        ...
        content: {
          ...
          categories_products: {
            ...
            left_panel: {
              ...
              products_list: {
                title:
                  homePage?.content?.categories_products?.left_panel
                    ?.products_list?.title,
                product_ids:
                  homePage?.content?.categories_products?.left_panel
              ...
              banner: {
                status:
                  homePage?.content?.categories_products?.left_panel?.banner
                    ?.status,
                image_url:
                  homePage?.content?.categories_products?.left_panel?.banner
                    ?.image_url,
                redirect_link: {
                  link: homePage?.content?.categories_products?.left_panel
            ...
            right_panel: {
              products_list: {
                title:
                  homePage?.content?.categories_products?.right_panel
                    ?.products_list?.title,
                product_ids:
                  homePage?.content?.categories_products?.right_panel
                    ?.products_list?.product_ids,
              ...
              offer_banner: {
                banner_1: {
                  image_url:
                    homePage?.content?.categories_products?.right_panel
                      ?.offer_banner?.banner_1?.image_url,
                  status:
                    homePage?.content?.categories_products?.right_panel
                      ?.offer_banner?.banner_1?.status,
                  redirect_link: {
                    link: homePage?.content?.categories_products?.right_panel
                      ?.offer_banner?.banner_1?.redirect_link?.link,
                    link_type:
                      homePage?.content?.categories_products?.right_panel
                        ?.offer_banner?.banner_1?.redirect_link?.link_type,
                    product_ids:
                      homePage?.content?.categories_products?.right_panel
                        ?.offer_banner?.banner_1?.redirect_link?.product_ids,
                  },
                },
                banner_2: {
                  image_url:
                    homePage?.content?.categories_products?.right_panel
                      ?.offer_banner?.banner_2?.image_url,
                  status:
                    homePage?.content?.categories_products?.right_panel
                      ?.offer_banner?.banner_2?.status,
                  redirect_link: {
                    link: homePage?.content?.categories_products?.right_panel
                      ?.offer_banner?.banner_2?.redirect_link?.link,
                    link_type:
                      homePage?.content?.categories_products?.right_panel
                        ?.offer_banner?.banner_2?.redirect_link?.link_type,
                    product_ids:
                      homePage?.content?.categories_products?.right_panel
                        ?.offer_banner?.banner_2?.redirect_link?.product_ids,
                  },
                },
              },
              category_product: {
