...
export class Marketplace4 {
  ...
  home_page$: Observable<IMarketplaceFour> = inject(Store).select(
    ThemeState.homePage,
  );
  ...
  ngOnInit() {
    ...
    const home_page$ = this.store.dispatch(
      new GetHomePageAction({ slug: "marketplace_four" }),
    );
      ...
      this.form.patchValue({
        content: {
          ...
          product_banner_1: {
            ...
            left_panel: {
              image_url:
                homePage?.content?.product_banner_1?.left_panel?.image_url,
              status:
                homePage?.content?.product_banner_1?.left_panel?.image_url,
              redirect_link: {
                link: homePage.content?.product_banner_1?.left_panel
                  ?.redirect_link?.link,
                link_type:
                  homePage?.content?.product_banner_1?.left_panel.redirect_link
                    ?.link_type,
                product_ids:
                  homePage?.content?.product_banner_1?.left_panel?.redirect_link
                    ?.product_ids,
            ...
            right_panel: {
              product_ids:
                homePage?.content?.product_banner_1?.right_panel?.product_ids,
          ...
          product_banner_2: {
            ...
            left_panel: {
              product_ids:
                homePage?.content?.product_banner_2?.left_panel?.product_ids,
            ...
            center_panel: {
              banner_1: {
                image_url:
                  homePage?.content?.product_banner_2?.center_panel.banner_1
                    ?.image_url,
                status:
                  homePage?.content?.product_banner_2?.center_panel.banner_1
                    ?.status,
                redirect_link: {
                  link: homePage?.content?.product_banner_2?.center_panel
              ...
              banner_2: {
                image_url:
                  homePage?.content?.product_banner_2?.center_panel.banner_2
                    ?.image_url,
                status:
                  homePage?.content?.product_banner_2?.center_panel.banner_2
                    ?.status,
            ...
            right_panel: {
              product_ids:
                homePage?.content?.product_banner_2?.right_panel?.product_ids,
          ...
          product_banner_3: {
            ...
            left_panel: {
              image_url:
                homePage?.content?.product_banner_3?.left_panel?.image_url,
              status: homePage?.content?.product_banner_3?.left_panel?.status,
              redirect_link: {
                link: homePage.content?.product_banner_3?.left_panel
                  ?.redirect_link?.link,
                link_type:
                  homePage?.content?.product_banner_3?.left_panel.redirect_link
                    ?.link_type,
                product_ids:
                  homePage?.content?.product_banner_3?.left_panel?.redirect_link
                    ?.product_ids,
            ...
            right_panel: {
              product_ids:
                homePage?.content?.product_banner_3?.right_panel?.product_ids,
