...
export class Marketplace2 {
  ...
  home_page$: Observable<IMarketplaceTwo> = inject(Store).select(
    ThemeState.homePage,
  );
  ...
  ngOnInit() {
    ...
    const home_page$ = this.store.dispatch(
      new GetHomePageAction({ slug: "marketplace_two" }),
    );
        ...
        content: {
          ...
          offer_banner_2: {
            ...
            banner_1: {
              ...
              redirect_link: {
                link: homePage?.content?.offer_banner_2?.banner_1?.redirect_link
                  ?.link,
                link_type:
                  homePage?.content?.offer_banner_2?.banner_1?.redirect_link
                    ?.link_type,
                product_ids:
                  homePage?.content?.offer_banner_2?.banner_1?.redirect_link
                    ?.product_ids,
            ...
            banner_2: {
              ...
              redirect_link: {
                link: homePage?.content?.offer_banner_2?.banner_2?.redirect_link
                  ?.link,
                link_type:
                  homePage?.content?.offer_banner_2?.banner_2?.redirect_link
                    ?.link_type,
                product_ids:
                  homePage?.content?.offer_banner_2?.banner_2?.redirect_link
                    ?.product_ids,
          ...
          offer_banner_3: {
            ...
            redirect_link: {
              ...
              link_type:
                homePage?.content?.offer_banner_3?.redirect_link?.link_type,
              product_ids:
                homePage?.content?.offer_banner_3?.redirect_link?.product_ids,
            },
          },
          brand: {
