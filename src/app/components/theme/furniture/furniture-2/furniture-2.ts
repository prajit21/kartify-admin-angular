...
export class Furniture2 {
  ...
  home_page$: Observable<IFurnitureTwo> = inject(Store).select(
    ThemeState.homePage,
  );
  ...
  ngOnInit() {
    ...
    const home_page$ = this.store.dispatch(
      new GetHomePageAction({ slug: "furniture_two" }),
    );
  ...
  patchForm() {
    this.home_page$.subscribe((homePage) => {
      ...
      this.selectedCategories =
        homePage?.content?.categories_icon_list?.category_ids || [];
        ...
        content: {
          ...
          product_list_2: {
            ...
            products: {
              product_item: {
                product_ids:
                  homePage?.content?.product_list_2?.products?.product_item
                    ?.product_ids,
              },
              product_banner: {
                banner_1: {
                  image_url:
                    homePage?.content?.product_list_2?.products?.product_banner
                      ?.banner_1?.image_url,
                  status:
                    homePage?.content?.product_list_2?.products?.product_banner
                      ?.banner_1?.status,
                  redirect_link: {
                    link: homePage?.content?.product_list_2?.products
                      ?.product_banner?.banner_1?.redirect_link?.link,
                    link_type:
                      homePage?.content?.product_list_2?.products
                        ?.product_banner?.banner_1?.redirect_link?.link_type,
                    product_ids:
                      homePage?.content?.product_list_2?.products
                        ?.product_banner?.banner_1?.redirect_link?.product_ids,
                  },
                },
                banner_2: {
                  image_url:
                  ...
                  redirect_link: {
                    link: homePage?.content?.product_list_2?.products
                      ?.product_banner?.banner_2?.redirect_link?.link,
                    link_type:
                      homePage?.content?.product_list_2?.products
                        ?.product_banner?.banner_2?.redirect_link?.link_type,
                    product_ids:
                      homePage?.content?.product_list_2?.products
                        ?.product_banner?.banner_2?.redirect_link?.product_ids,
                  },
                },
              },
            },
            right_panel: {
              ...
              product_ids:
                homePage?.content?.product_list_2?.right_panel?.product_ids,
