...
export class FurnitureDark {
  ...
  home_page$: Observable<IFurnitureDark> = inject(Store).select(
    ThemeState.homePage,
  );
  ...
  ngOnInit() {
    ...
    const home_page$ = this.store.dispatch(
      new GetHomePageAction({ slug: "furniture_dark" }),
    );
      ...
      this.form.patchValue({
        content: {
          ...
          banner: {
            ...
            banner_1: {
              ...
              redirect_link: {
                ...
                link_type:
                  homePage?.content?.banner?.banner_1?.redirect_link?.link_type,
                product_ids:
                  homePage?.content?.banner?.banner_1?.redirect_link
                    ?.product_ids,
              },
            },
            banner_2: {
              ...
              redirect_link: {
                ...
                link_type:
                  homePage?.content?.banner?.banner_2?.redirect_link?.link_type,
                product_ids:
                  homePage?.content?.banner?.banner_2?.redirect_link
                    ?.product_ids,
              },
            },
            banner_3: {
              ...
              redirect_link: {
                ...
                link_type:
                  homePage?.content?.banner?.banner_3?.redirect_link?.link_type,
                product_ids:
                  homePage?.content?.banner?.banner_3?.redirect_link
                    ?.product_ids,
              },
            },
          },
          product_list_2: {
            ...
            left_panel: {
              image_url:
                homePage?.content?.product_list_2?.left_panel?.image_url,
              status: homePage?.content?.product_list_2?.left_panel?.status,
              redirect_link: {
                link: homePage?.content?.product_list_2?.left_panel
                  ?.redirect_link?.link,
                link_type:
                  homePage?.content?.product_list_2?.left_panel?.redirect_link
                    ?.link_type,
                product_ids:
                  homePage?.content?.product_list_2?.left_panel?.redirect_link
                    ?.product_ids,
            ...
            products: {
              product_ids:
                homePage?.content?.product_list_2?.products?.product_ids,
            },
          },
          services: {
