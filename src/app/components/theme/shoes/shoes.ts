...
export class Shoes {
  ...
  ngOnInit() {
    ...
    const home_page$ = this.store.dispatch(
      new GetHomePageAction({ slug: "shoes" }),
    );
        ...
        content: {
          ...
          about_banner: {
            ...
            collection_banner: {
              banner_1: {
                status:
                  homePage?.content?.about_banner?.collection_banner?.banner_1
                    ?.status,
                image_url:
                  homePage?.content?.about_banner?.collection_banner?.banner_1
                    ?.image_url,
                redirect_link: {
                  link: homePage?.content?.about_banner?.collection_banner
              ...
              banner_2: {
                status:
                  homePage?.content?.about_banner?.collection_banner?.banner_2
                    ?.status,
                image_url:
                  homePage?.content?.about_banner?.collection_banner?.banner_2
                    ?.image_url,
