...
export class Fashion7 {
  ...
  home_page$: Observable<IFashionSeven> = inject(Store).select(
    ThemeState.homePage,
  );
  ...
  ngOnInit() {
    ...
    const home_page$ = this.store.dispatch(
      new GetHomePageAction({ slug: "fashion_seven" }),
    );
        ...
        content: {
          home_banner: {
            ...
            redirect_link: {
              ...
              link_type:
                homePage?.content?.home_banner?.redirect_link?.link_type,
              product_ids:
                homePage?.content?.home_banner?.redirect_link?.product_ids,
            },
          },
          featured_banners: {
            banner_1: {
              ...
              image_url:
                homePage?.content?.featured_banners?.banner_1?.image_url,
              redirect_link: {
                link: homePage?.content?.featured_banners?.banner_1
                  ?.redirect_link?.link,
                link_type:
                  homePage?.content?.featured_banners?.banner_1?.redirect_link
                    ?.link_type,
                product_ids:
                  homePage?.content?.featured_banners?.banner_1?.redirect_link
                    ?.product_ids,
            ...
            banner_2: {
              ...
              image_url:
                homePage?.content?.featured_banners?.banner_2?.image_url,
              redirect_link: {
                link: homePage?.content?.featured_banners?.banner_2
                  ?.redirect_link?.link,
                link_type:
                  homePage?.content?.featured_banners?.banner_2?.redirect_link
                    ?.link_type,
                product_ids:
                  homePage?.content?.featured_banners?.banner_2?.redirect_link
                    ?.product_ids,
            ...
            banner_3: {
              ...
              image_url:
                homePage?.content?.featured_banners?.banner_3?.image_url,
              redirect_link: {
                link: homePage?.content?.featured_banners?.banner_3
                  ?.redirect_link?.link,
                link_type:
                  homePage?.content?.featured_banners?.banner_3?.redirect_link
                    ?.link_type,
                product_ids:
                  homePage?.content?.featured_banners?.banner_3?.redirect_link
                    ?.product_ids,
          ...
          products_list_2: {
            ...
            left_panel: {
              ...
              description:
                homePage?.content?.products_list_2?.left_panel?.description,
              more_button:
                homePage?.content?.products_list_2?.left_panel?.more_button,
              button_text:
                homePage?.content?.products_list_2?.left_panel?.button_text,
              status: homePage?.content?.products_list_2?.left_panel?.status,
              redirect_link: {
                link: homePage?.content?.products_list_2?.left_panel
                  ?.redirect_link?.link,
                link_type:
                  homePage?.content?.products_list_2?.left_panel?.redirect_link
                    ?.link_type,
                product_ids:
                  homePage?.content?.products_list_2?.left_panel?.redirect_link
                    ?.product_ids,
            ...
            products: {
              product_ids:
                homePage?.content?.products_list_2?.products?.product_ids,
            },
          },
          offer_banner: {
            banner_1: {
              ...
              redirect_link: {
                link: homePage?.content?.offer_banner?.banner_1?.redirect_link
                  ?.link,
                link_type:
                  homePage?.content?.offer_banner?.banner_1?.redirect_link
                    ?.link_type,
                product_ids:
                  homePage?.content?.offer_banner?.banner_1?.redirect_link
                    ?.product_ids,
            ...
            banner_2: {
              ...
              redirect_link: {
                link: homePage?.content?.offer_banner?.banner_2?.redirect_link
                  ?.link,
                link_type:
                  homePage?.content?.offer_banner?.banner_2?.redirect_link
                    ?.link_type,
                product_ids:
                  homePage?.content?.offer_banner?.banner_2?.redirect_link
                    ?.product_ids,
