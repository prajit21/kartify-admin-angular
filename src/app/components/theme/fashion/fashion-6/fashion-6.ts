...
export class Fashion6 {
  ...
  home_page$: Observable<IFashionSix> = inject(Store).select(
    ThemeState.homePage,
  );
  ...
  ngOnInit() {
    const home_page$ = this.store.dispatch(
      new GetHomePageAction({ slug: "fashion_six" }),
    );
          ...
          content: {
            ...
            offer_banner: {
              ...
              banner_5: {
                ...
                redirect_link: {
                  link: homePage?.content?.offer_banner?.banner_5?.redirect_link
                    ?.link,
                  link_type:
                    homePage?.content?.offer_banner?.banner_5?.redirect_link
                      ?.link_type,
                  product_ids:
                    homePage?.content?.offer_banner?.banner_5?.redirect_link
                      ?.product_ids,
              ...
              banner_6: {
                ...
                redirect_link: {
                  link: homePage?.content?.offer_banner?.banner_6?.redirect_link
                    ?.link,
                  link_type:
                    homePage?.content?.offer_banner?.banner_6?.redirect_link
                      ?.link_type,
                  product_ids:
                    homePage?.content?.offer_banner?.banner_6?.redirect_link
                      ?.product_ids,
            ...
            product_banner: {
              ...
              product_slider_1: {
                title:
                  homePage?.content?.product_banner?.product_slider_1?.title,
                product_ids:
                  homePage?.content?.product_banner?.product_slider_1
                    ?.product_ids,
                status:
                  homePage?.content?.product_banner?.product_slider_1?.status,
              },
            },
            products_list_2: {
              ...
              right_panel: {
                image_url:
                  homePage?.content?.products_list_2?.right_panel?.image_url,
