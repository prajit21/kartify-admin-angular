...
export class Fashion5 {
  ...
  home_page$: Observable<IFashionFive> = inject(Store).select(
    ThemeState.homePage,
  );
  ...
  ngOnInit() {
    ...
    const home_page$ = this.store.dispatch(
      new GetHomePageAction({ slug: "fashion_five" }),
    );
  ...
  patchForm() {
    this.home_page$.subscribe((homePage) => {
      ...
      this.selectedCategoriesProduct =
        ...
        content: {
          ...
          deals_banner: {
            ...
            redirect_link: {
              ...
              link_type:
                homePage?.content?.deals_banner?.redirect_link?.link_type,
              product_ids:
                homePage?.content?.deals_banner?.redirect_link?.product_ids,
            },
          },
          category_product: {
          ...
          offer_banner: {
            ...
            redirect_link: {
              ...
              link_type:
                homePage?.content?.offer_banner?.redirect_link?.link_type,
              product_ids:
                homePage?.content?.offer_banner?.redirect_link?.product_ids,
            },
          },
          social_media: {
