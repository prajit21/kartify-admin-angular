...
export class SingleProduct {
  ...
  home_page$: Observable<ISingleProduct> = inject(Store).select(
    ThemeState.homePage,
  );
  ...
  ngOnInit() {
    ...
    const home_page$ = this.store.dispatch(
      new GetHomePageAction({ slug: "single_product" }),
    );
  ...
  patchForm() {
    this.home_page$.subscribe((homePage) => {
        ...
        content: {
          ...
          grid_banner: {
            banner_1: {
              ...
              redirect_link: {
                link: homePage?.content?.grid_banner?.banner_1?.redirect_link
                  ?.link,
                link_type:
                  homePage?.content?.grid_banner?.banner_1?.redirect_link
                    ?.link_type,
                product_ids:
                  homePage?.content?.grid_banner?.banner_1?.redirect_link
                    ?.product_ids,
            ...
            banner_2: {
              ...
              redirect_link: {
                link: homePage?.content?.grid_banner?.banner_2?.redirect_link
                  ?.link,
                link_type:
                  homePage?.content?.grid_banner?.banner_2?.redirect_link
                    ?.link_type,
                product_ids:
                  homePage?.content?.grid_banner?.banner_2?.redirect_link
                    ?.product_ids,
            ...
            banner_3: {
              ...
              redirect_link: {
                link: homePage?.content?.grid_banner?.banner_3?.redirect_link
                  ?.link,
                link_type:
                  homePage?.content?.grid_banner?.banner_3?.redirect_link
                    ?.link_type,
                product_ids:
                  homePage?.content?.grid_banner?.banner_3?.redirect_link
                    ?.product_ids,
      ...
      homePage?.content?.services?.right_panel?.banners?.forEach(
        (banner: IBanners) =>
      ...
      homePage?.content?.testimonial?.banners?.forEach(
        (banner: ITestimonialBanner) =>
