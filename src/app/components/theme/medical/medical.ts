...
export class Medical {
  ...
  ngOnInit() {
    ...
    const home_page$ = this.store.dispatch(
      new GetHomePageAction({ slug: "medical" }),
    );
  ...
  patchForm() {
    this.home_page$.subscribe((homePage) => {
      ...
      this.selectedCategories =
        homePage?.content?.categories?.category_ids || [];
      ...
      this.form.patchValue({
        content: {
          ...
          column_banner_product: {
            ...
            product_list_1: {
              product_ids:
                homePage?.content?.column_banner_product?.product_list_1
                  ?.product_ids,
              title:
                homePage?.content?.column_banner_product?.product_list_1?.title,
              status:
                homePage?.content?.column_banner_product?.product_list_1
                  ?.status,
            },
            offer_banner_1: {
              image_url:
                homePage?.content?.column_banner_product?.offer_banner_1
                  ?.image_url,
              status:
                homePage?.content?.column_banner_product?.offer_banner_1
                  ?.status,
              redirect_link: {
                link: homePage?.content?.column_banner_product?.offer_banner_1
                  ?.redirect_link?.link,
                link_type:
                  homePage?.content?.column_banner_product?.offer_banner_1
            ...
            product_list_2: {
              product_ids:
                homePage?.content?.column_banner_product?.product_list_2
                  ?.product_ids,
              title:
                homePage?.content?.column_banner_product?.product_list_2?.title,
              status:
                homePage?.content?.column_banner_product?.product_list_2
                  ?.status,
            },
            offer_banner_2: {
              image_url:
                homePage?.content?.column_banner_product?.offer_banner_2
                  ?.image_url,
              status:
                homePage?.content?.column_banner_product?.offer_banner_2
                  ?.status,
              redirect_link: {
                link: homePage?.content?.column_banner_product?.offer_banner_2
                  ?.redirect_link?.link,
                link_type:
                  homePage?.content?.column_banner_product?.offer_banner_2
                    ?.redirect_link?.link_type,
