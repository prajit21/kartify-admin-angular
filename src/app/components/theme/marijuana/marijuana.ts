...
export class Marijuana {
  ...
  home_page$: Observable<IMarijuana> = inject(Store).select(
    ThemeState.homePage,
  );
  ...
  ngOnInit() {
    ...
    const home_page$ = this.store.dispatch(
      new GetHomePageAction({ slug: "marijuana" }),
    );
        ...
        content: {
          ...
          offer_banner: {
            ...
            banner: {
              banner_1: {
                status:
                  homePage?.content?.offer_banner?.banner?.banner_1?.status,
                image_url:
                  homePage?.content?.offer_banner?.banner?.banner_1?.image_url,
                redirect_link: {
                  link: homePage?.content?.offer_banner?.banner?.banner_1
                    ?.redirect_link?.link,
                  link_type:
                    homePage?.content?.offer_banner?.banner?.banner_1
              ...
              banner_2: {
                status:
                  homePage?.content?.offer_banner?.banner?.banner_2?.status,
                image_url:
                  homePage?.content?.offer_banner?.banner?.banner_2?.image_url,
                redirect_link: {
                  link: homePage?.content?.offer_banner?.banner?.banner_2
                    ?.redirect_link?.link,
                  link_type:
                    homePage?.content?.offer_banner?.banner?.banner_2
                      ?.redirect_link?.link_type,
                  product_ids:
                    homePage?.content?.offer_banner?.banner?.banner_2
                      ?.redirect_link?.product_ids,
