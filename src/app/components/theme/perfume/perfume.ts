...
export class Perfume {
  ...
  ngOnInit() {
    ...
    const home_page$ = this.store.dispatch(
      new GetHomePageAction({ slug: "perfume" }),
    );
        ...
        content: {
          ...
          collection_banner: {
            ...
            redirect_link: {
              ...
              link_type:
                homePage?.content?.collection_banner?.redirect_link?.link_type,
              product_ids:
                homePage?.content?.collection_banner?.redirect_link
                  ?.product_ids,
            },
          },
          product_list: {
            ...
            left_panel: {
              ...
              description:
                homePage?.content?.product_list?.left_panel?.description,
              more_button:
                homePage?.content?.product_list?.left_panel?.more_button,
              button_text:
                homePage?.content?.product_list?.left_panel?.button_text,
              status: homePage?.content?.product_list?.left_panel?.status,
              redirect_link: {
                link: homePage?.content?.product_list?.left_panel?.redirect_link
                  ?.link,
                link_type:
                  homePage?.content?.product_list?.left_panel?.redirect_link
                    ?.link_type,
                product_ids:
                  homePage?.content?.product_list?.left_panel?.redirect_link
                    ?.product_ids,
            ...
            products: {
              product_ids:
                homePage?.content?.product_list?.products?.product_ids,
            },
          },
          offer_banner_2: {
