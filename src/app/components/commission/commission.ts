...
import {
  ICommission,
  ICommissionModel,
} from "../../shared/interface/commission.interface";
...
export class Commission {
  ...
  commission$: Observable<ICommissionModel> = inject(Store).select(
  ...
  public tableConfig = {
    columns: [
      ...
      {
        title: "vendor_commission",
        dataField: "vendor_commission",
        type: "price",
      },
